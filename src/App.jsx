...
import bg from "../src/assets/background3.jpg";
import "./App.css";
  ...
  return (
    <div className="app" style={{ backgroundImage: `url(${bg})` }}>
        ...
        weather &&(
          ...
          <div className="col-sm-11 input-and-btn">
        ...
        <div className="row details">
          <div className="col-sm-4 min">
            <h6>Min<WiDirectionDown className="icon min-icon" /></h6>
            <h3>{weather.temp_min}</h3>
          </div>
          <div className="col-sm-4 max">
            <h6>Max<WiDirectionUp className="icon" /></h6>
